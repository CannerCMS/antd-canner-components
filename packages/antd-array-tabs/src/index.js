...
const TabUi = (props: Props) => {
  ...
  class DraggableTabs extends React.Component {
    ...
    moveTabNode = (dragKey, hoverKey) => {
      ...
      this.setState({
        ...
        setActiveKey(`${hoverIndex}`);
        onChange({firstRefId: refId.child(dragIndex), secondRefId: refId.child(hoverIndex)}, "swap")
      });
    };
  ...
  return (
    <div style={{width: '100%'}}>
      <DraggableTabs
        tabBarExtraContent={<Button style={{margin: '6px'}}onClick={handleCreate}>+ Add</Button>}
